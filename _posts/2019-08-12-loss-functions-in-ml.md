...
<!--START formula-->
<div class="formula">
  $$ KL(p, q)=\sum_{k=1}^Kp\mathbb{log}(p) - \sum_{k=1}^Kp\mathbb{log}(q) $$
</div>
<!--END formula-->
...
<!--START formula-->
<div class="formula">
  $$ KL(y_i^{\star}, \hat{y_i})=\sum_{k=1}^Ky_i^{\star}\mathbb{log}(y_i^{\star}) - \sum_{k=1}^Ky_i^{\star}\mathbb{log}(\hat{y_i}) $$
</div>
<!--END formula-->
...
<!--START formula-->
<div class="formula">
  $$ \sum_{k=1}^Ky_i^{\star}\mathbb{log}(\hat{y_i}) $$
</div>
<!--END formula-->
